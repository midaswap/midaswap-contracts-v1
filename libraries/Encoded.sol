...
library Encoded {
    ...
    function set(
        ...
        uint256 mask,
        uint256 offset
    ) internal pure returns (bytes32 newEncoded) {
        assembly {
    ...
    function decodeBool(
        bytes32 encoded,
        uint256 offset
    ) internal pure returns (bool boolean) {
        assembly {
